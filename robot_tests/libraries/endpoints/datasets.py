...
def list_datasets(client: Client) -> QCrBoxResponseDatasetsResponse | QCrBoxErrorResponse | None:
...
def create_dataset(
    client: Client, body: CreateDatasetBody
...
def delete_dataset_by_id(client: Client, id: str) -> QCrBoxErrorResponse | None:
    from qcrboxapiclient.api.datasets import delete_dataset_by_id

    return delete_dataset_by_id.sync(id=id, client=client)


def get_dataset_by_id(client: Client, id: str) -> QCrBoxResponseDatasetsResponse | QCrBoxErrorResponse | None:
    from qcrboxapiclient.api.datasets import get_dataset_by_id

    return get_dataset_by_id.sync(id=id, client=client)


def download_dataset_by_id(client: Client, id: str) -> bytes | str | QCrBoxErrorResponse | None:
