...
class DatasetResponseDataFiles:
    ...
    additional_properties: dict[str, "DataFileMetadataResponse"] = _attrs_field(init=False, factory=dict)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for prop_name, prop_dict in d.items():
            additional_property = DataFileMetadataResponse.from_dict(prop_dict)
    ...
    def __getitem__(self, key: str) -> "DataFileMetadataResponse":
        return self.additional_properties[key]

    def __setitem__(self, key: str, value: "DataFileMetadataResponse") -> None:
